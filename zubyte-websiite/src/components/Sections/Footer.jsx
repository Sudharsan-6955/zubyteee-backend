          ...
          <FooterContent>
            ...
            <RightSide>
              ...
              <LinksGroup>
                ...
                <SocialIcons>
                  <a href="https://www.instagram.com/zubyte_solutions" target="_blank" rel="noopener noreferrer">
                    <FontAwesomeIcon icon={faInstagram} size="lg" style={{ color: "#E1306C" }} />
                  </a>
                  <a href="mailto:your.zubytesolutions@gmail.com" target="_blank" rel="noopener noreferrer">
                    <FontAwesomeIcon icon={faEnvelope} size="lg" style={{ color: "#D44638" }} />
                  </a>
                  <a href="https://twitter.com/zubyte_solutions" target="_blank" rel="noopener noreferrer">
